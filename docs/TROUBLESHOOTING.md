...
MacOS computers will notify you that they cannot verify if a file you downloaded from internet is free from malware and it will pop you the following message:
