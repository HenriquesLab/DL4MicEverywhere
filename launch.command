...
/bin/bash $BASEDIR/.tools/bash_tools/pre_launch_test.sh || (sleep 0.1 ; osascript -e 'tell application "Terminal" to quit') &
...
/bin/bash $BASEDIR/.tools/bash_tools/pre_build_test.sh || (sleep 0.1 ; osascript -e 'tell application "Terminal" to quit') &
...
/bin/bash $BASEDIR/.tools/bash_tools/post_build_test.sh || (sleep 0.1 ; osascript -e 'tell application "Terminal" to quit') &
